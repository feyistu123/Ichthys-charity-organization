      ...
      {step === 1 && (
        <form className="login-form" onSubmit={handleSendCode}>
          ...
          <input
            ...
            required
          />
          <button className="login-btn" type="submit">Send Reset Code</button>
        </form>
      )}

      {step === 2 && (
        <form className="login-form" onSubmit={handleVerifyCode}>
          <p style={{color: '#2563eb', textAlign: 'center', marginBottom: '1rem'}}>
          ...
          <input
            ...
            required
          />
          <button className="login-btn" type="submit">Verify Code</button>
        </form>
      )}
